                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        <div class="title-with-icon">
                            <span class="icon"><img src="images/instagram.png" alt=""></span><span class="text">Instagram Oto İzleme Paketleri</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container pull-top">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">500 Otoİzlenme</div>
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/820402">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>Hizmet Süresi; 1 Ay</li>
								<center><p>----------------------------------</p></center>
                                <li>Güvenli Ödeme</li>
								<li>Anında Teslim</li>
                                <li>Kaliteli Kullanıcılar</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">1.000 Otoİzlenmme</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">70,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/827281">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>Hizmet Süresi; 1 Ay</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">2.000 Otoİzlenmme</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">100,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/819754">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>Hizmet Süresi; 1 Ay</li>
		...
		<div class="pricing-holder">
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">3.000 Otoİzlenmme</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">130,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/828484">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>Hizmet Süresi; 1 Ay</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">4.000 Otoİzlenmme</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">160,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/823103">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>Hizmet Süresi; 1 Ay</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">5.000 Otoİzlenmme</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">190,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/822788">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>Hizmet Süresi; 1 Ay</li>
        ...
        <form>
            <div class="row">
                <div class="col-sm-12 col-md-9 col-lg-8">
                    ...
                    <div class="post-link">
                        <a href="dusus-engelleyici.php" class="hbtn hbtn-blue hbtn-lg">Hemen Göz At.</a>
                    </div>
                </div>
