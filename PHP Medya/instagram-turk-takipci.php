                                    ...
                                    <div class="dropdown-menu custom-dropdown-menu" aria-labelledby="navbarDropdown">
                                        <div class="dropdown-items-holder">
                                            <div class="items-with-icon">
                                                <div class="row">
													<div class="col-xs-6">
                                                        ...
                                                        <a href="instagram-turk-takipci.php" class="link-with-icon">
                                                            <span class="icon"><img src="images/icon/takipci.png" alt=""></span>
                                                            <span class="text">Türk Takipçi Pak.</span>
                                                        </a>
                                            ...
                                            <div class="items">
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        <a href="kullanim-sozslesmesi.php" class="link">Kullanım Sözleşmesi</a>
                                                    </div>
                                                    <div class="col-xs-6">
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        <div class="title-with-icon">
                            <span class="icon"><img src="images/instagram.png" alt=""></span><span class="text">Instagram Türk Takipçi Paketleri</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container pull-top">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">500 Türk Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency"><del><small>29,90₺</small></del> 14,90₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/765436">Ödeme Yap</a>
                        </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">1.000 Türk Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency"><del><small>44,90₺</small></del> 24,90₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/762771">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">2.000 Türk Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency"><del><small>59,90₺</small></del> 39,90₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/761514">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
		...
		<div class="pricing-holder">
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">3.000 Türk Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency"><del><small>79,90₺</small></del> 59,90₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/761076">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">4.000 Türk Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency"><del><small>99,90₺</small></del> 79,90₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/762729">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">5.000 Türk Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency"><del><small>119,90₺</small></del> 99,90₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/765474">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
