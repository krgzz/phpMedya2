                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        <div class="title-with-icon">
                            <span class="icon"><img src="images/instagram.png" alt=""></span><span class="text">Instagram İzlenme Paketleri</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container pull-top">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">500 İzlenme</div>
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/822118">Ödeme Yap</a>
                        </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">1.000 İzlenme</div>
                        <div class="pricing-price">
                            <div class="price">
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/826598">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">2.000 İzlenme</div>
                        <div class="pricing-price">
                            <div class="price">
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/828444">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
		...
		<div class="pricing-holder">
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">3.000 İzlenme</div>
                        <div class="pricing-price">
                            <div class="price">
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/822841">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">4.000 İzlenme</div>
                        <div class="pricing-price">
                            <div class="price">
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/823125">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">5.000 İzlenme</div>
                        <div class="pricing-price">
                            <div class="price">
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/826636">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
		...
		<div class="pricing-holder">
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">10.000 İzlenme</div>
                        <div class="pricing-price">
                            <div class="price">
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/820490">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">20.000 İzlenme</div>
                        <div class="pricing-price">
                            <div class="price">
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/821873">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">40.000 İzlenme</div>
                        <div class="pricing-price">
                            <div class="price">
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/820527">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
		...
		<div class="pricing-holder">
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">60.000 İzlenme</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">115,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/822374">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">80.000 İzlenme</div>
                        <div class="pricing-price">
                            <div class="price">
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/820530">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">100.000 İzlenme</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">175,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/828710">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
