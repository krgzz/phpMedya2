                ...
                <div class="pricing-icon pricing-color1">
                    <div class="page-title">
                        <div class="title-with-icon">
                            <span class="icon"><img src="images/instagram.png" alt=""></span><span class="text">İnstagram Takipçi Paketleri</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container pull-top">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">500 Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">7,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/823615">Ödeme Yap</a>
                        </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">1.000 Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/826661">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">2.000 Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/821830">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
		...
		<div class="pricing-holder">
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">3.000 Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/826737">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">4.000 Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">32,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/826775">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">5.000 Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">45,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/822812">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
		...
		<div class="pricing-holder">
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">10.000 Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                        ...
                        <div class="pricing-button">
                            <a href="https://shopier.com/824597">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">20.000 Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">150,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/826813">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">40.000 Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">300,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/826927">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
		...
		<div class="pricing-holder">
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">60.000 Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">380,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/821783">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">80.000 Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">550,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/825396">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="pricing-box inner">
                        <div class="pricing-title">100.000 Takipçi</div>
                        <div class="pricing-price">
                            <div class="price">
                                <span class="currency">800,00₺</span><span class="duration"></span>
                            </div>
                        </div>
                        <div class="pricing-button">
                            <a href="https://shopier.com/827041">Ödeme Yap</a>
                        </div>
                        <div class="pricing-details">
                            <ul>
                                <li>%20 Bonus</li>
