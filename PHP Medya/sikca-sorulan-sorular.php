...
<div id="header-holder" class="innerpage clouds-bg">
    ...
    <div id="top-content" class="container-fluid">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title">SIKÇA SORULAN SOLURLAR</div>
                </div>
            </div>
        </div>
    </div>
...
<div class="questions container-fluid">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="row-title">Herkesin sorduğu soruları derledik. Aklınıza takılan bir sorun varsa lütfen bizimle iletişim kurunuz..</div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="cards-holder">
                    <div class="card question-card">
                        <div class="card-header question-holder">
                            <button type="button" data-toggle="collapse" data-target="#ques1">Neden CES Medya?</button>
                        </div>
                        <div id="ques1" class="collapse in">
                            <div class="card-body answer-holder">
                                Sizlere elimizden geldiği kadar en iyi hizmeti veriyoruz. Sayfamızda 4096bit SSL (Güvenlik Sertifakası) bulunmaktadır. Sayfamızda güvenliğiniz amacıyla pek çok güvenlik duvarı var. Buna örnek olarak 3D Secure diyebiliriz. CES Medya sosyal medya hizmetilerini seçerek bir adım önde olabilir, rakip sayfalarınızın önüne bir adım daha geçebilirsiniz..
                            </div>
                        </div>
                    </div>
                    <div class="card question-card">
                        <div class="card-header question-holder">
                            <button type="button" data-toggle="collapse" data-target="#ques2" class="collapsed">Bu işe Ne Zaman Başladık?</button>
                        </div>
                        <div id="ques2" class="collapse">
                            <div class="card-body answer-holder">
                                Bu işe 1 Sene Önce Panelde Başlandı. Ekip Bölündü Ve CES Medya Ekibi Toplandı...
                            </div>
                        </div>
                    </div>
                    <div class="card question-card">
                        <div class="card-header question-holder">
                            <button type="button" data-toggle="collapse" data-target="#ques3" class="collapsed">Kullanım Sözleşmesi Neden Önemli?</button>
                        </div>
                        <div id="ques3" class="collapse">
                            <div class="card-body answer-holder">
                                Kullanım Sözleşmezi Sizin Bilmediğiniz Ve Bizim Anlattığımız Site Hakkındaki Bilgiler.. Bu Yüzden Sitemizde "YANLIŞLIKLA" Hataya DüşmeyinDiye Yazılan Metin.. Bu Yüzden Önemli...
                            </div>
                        </div>
                    </div>
                    <div class="card question-card">
                        <div class="card-header question-holder">
                            <button type="button" data-toggle="collapse" data-target="#ques4" class="collapsed">EFT/HAVALE ile ödeme yöntemi mevcut mu?</button>
                        </div>
                        <div id="ques4" class="collapse">
                            <div class="card-body answer-holder">
                                Tabii ki mevcut.. EFT/HAVALE ile alışveriş yapmak için bizlere ulaşmanız yeterli olacaktır.
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <form>
            <div class="row">
                <div class="col-sm-12 col-md-9 col-lg-8">
                    <div class="title">Düşüş Engelleyici Paketlerimizi<br> 
                            Detaylı Bir Biçim de İncelediniz mi?</div>
                    <div class="post-link">
                        <a href="dusus-engelleyici.php" class="hbtn hbtn-blue hbtn-lg">Daha Fazlasını Öğren...</a>
                    </div>
                </div>
...
<script data-cfasync="false" src="cdn-cgi/scripts/f2bf09f8/cloudflare-static/email-decode.min.html"></script><script type="text/javascript" src="js/jquery.min.js"></script>
